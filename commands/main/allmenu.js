...
export const renderAllMenu = async () => {
  const lines = [
    ...
    "",
    `${UI.title("Multi-device")} 📱`,
    "ᥫ᭡ .mdstatus — Status multi-device",
    "ᥫ᭡ .mdsync — Sinkronisasi perangkat",
    "ᥫ᭡ .mddevices — Daftar perangkat terhubung",
    "ᥫ᭡ .multidevice — Info multi-device",
    "",
    `${UI.title("Owner")} 🌹`,
